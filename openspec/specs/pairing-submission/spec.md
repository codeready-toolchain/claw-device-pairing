...
This specification defines the UI workflow for handling NOT_PAIRED errors during WebSocket handshake and submitting pairing requests to the backend. It establishes error handling, request submission, response handling, and visual feedback for the device pairing process.

# spinner-status Specification

## Purpose

This specification defines the spinner and status label components used to communicate progress during the device pairing flow. Instead of a multi-step progress stepper, a single centered spinner with a descriptive text label conveys the current stage, providing a simpler and cleaner user experience.
